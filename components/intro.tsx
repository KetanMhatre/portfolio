...
function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className='font-bold'>Hello, I'm Ketan Mhatre.</span> I'm a{' '}
        <span className='font-bold'>Full-stack developer.</span> I enjoy
        building <span className='italic'>sites & apps</span><div className="br"></div> My focus is{' '}
      ...
      >
        ...
        <a
          ...
          href='https://www.linkedin.com/in/ketan-mhatre-09731b214/'
          target='_blank'
        >
          <BsLinkedin />
        </a>
        <a
          ...
          href='https://github.com/KetanMhatre'
          target='_blank'
        >
          <FaGithubSquare />
        </a>
